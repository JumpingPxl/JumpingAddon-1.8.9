...
public class TransformHandler implements IClassTransformer {
	...
	private String renderItemClass = (LabyModCoreMod.isObfuscated() ? "bjh" : "net.minecraft.client.renderer.entity.RenderItem");
	private String renderGlintEffect = (LabyModCoreMod.isObfuscated() ? "(Lboq;)V" : "(Lnet/minecraft/client/resources/model/IBakedModel;)V");
					...
					if (desc.equals(renderGlintEffect)) {
						...
						return new MethodVisitor(262144) {
							...
							public void visitLdcInsn(Object cst) {
								if (cst.equals(-8372020) && jumpingAddon.getSettings().getColoredGlint().getAsBoolean()) {
									super.visitFieldInsn(1604, "de.jumpingpxl.jumpingaddon.util.Settings", "glintColor", "I");
								} else {
